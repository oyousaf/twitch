      ...
      <div className="flex grow items-center justify-start">
        ...
        <div className="p-4">
          <Menu as="div" className="relative text-left">
            ...
            >
              <Menu.Items className="origin-top-right absolute left-0 mt-2 w-25 rounded-md shadow-lg bg-[#0e0e10] ring-1 ring-white ring-opacity-5 focus:outline-none">
                <div className="py-1">
                  <Menu.Item>
                    {({ active }) => (
                      <a
      ...
      <div className="hidden md:flex grow items-center justify-end">
        {session ? (
          <div className="flex items-center">
            ...
            <div className="flex">
              <Menu.Button>
                <Image src={session.user.image} alt="/" height="30" width="30" className="rounded-full" />
              </Menu.Button>
            </div>
            ...
            <Transition
              ...
              leaveTo="transform opacity-0 scale-95"
            >
              <Menu.Items className="origin-top-right absolute right-0 mt-2 w-25 rounded-md shadow-lg bg-[#0e0e10] ring-1 ring-white ring-opacity-5 focus:outline-none">
                <div className="py-1">
                  <Menu.Item>
                    {({ active }) => (
                      <Link
